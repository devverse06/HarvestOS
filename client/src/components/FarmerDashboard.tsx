...
import { Sprout, Calendar, Truck, ArrowUpRight } from 'lucide-react';
    ...
    <div className="p-6 max-w-7xl mx-auto font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        >
          ...
          <h3 className="text-slate-500 text-sm font-medium">Tracked Harvest Lots</h3>
          <p className="text-2xl font-bold text-slate-900 mt-1">{myLots.length}</p>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-bold text-amber-600 bg-amber-50 px-2 py-1 rounded-full">Current</span>
          </div>
          <h3 className="text-slate-500 text-sm font-medium">Lots in Storage</h3>
          <p className="text-2xl font-bold text-slate-900 mt-1">{myLots.filter(lot => lot.status === 'Storage').length}</p>
        </motion.div>
        ...
        >
          ...
          <div className="relative">
            ...
            <h3 className="text-slate-500 text-sm font-medium">Data Scope</h3>
            <p className="text-base font-bold text-slate-900 mt-2">Harvest lots only</p>
          </div>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div>
          <div className="bg-slate-900 rounded-lg shadow-sm overflow-hidden text-white p-5">
            <h3 className="font-semibold mb-4 text-slate-200">Operational Data</h3>
            <p className="text-sm text-slate-300 leading-relaxed">This dashboard currently reports harvest-lot records from the backend. Weather, payments, and pickup schedules are not connected.</p>
          </div>
        </div>
      </div>
    </div>
