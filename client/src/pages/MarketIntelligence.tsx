      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-semibold text-slate-900 tracking-tight">Market Intelligence (Prototype)</h1>
          </div>
          <p className="text-[13px] text-slate-500">Static sample data for a future market-data integration.</p>
        </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {COMMODITIES.map((com) => (
              <div
                ...
                className={`p-4 rounded-lg border cursor-pointer transition-all ${selectedCommodity === com.name
