      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-semibold text-slate-900 tracking-tight">Route Planning (Prototype)</h1>
          </div>
          <p className="text-[14px] text-slate-500">Prototype view mapped from shipment records; route and risk values are not persisted.</p>
        </div>
                ...
                <div className="mt-auto">
                  ...
                  <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg border border-slate-200">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-6 py-2.5 rounded-lg font-bold text-sm transition-all ${routeAccepted
